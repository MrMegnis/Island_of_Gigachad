...
class Main_Menu:
    def __init__(self, width, height, start_button_func=None, exit_button_func=None):
        ...
        self.start_button = Button(0, 0, start_button_func, image="data/graphics/gui/buttons/start_button.png",
                                   color="green")
        self.exit_button = Button(0, 0, exit_button_func, image="data/graphics/gui/buttons/exit_button.png",
                                  color="red")
