...
class Enemy(Creature):
    def __init__(self, left: int, top: int, settings_path: str, move_speed: int = 150, hp : int = 50,
                 name: str = "aboba_warrior") -> None:
        super(Enemy, self).__init__(left, top, settings_path, move_speed=move_speed, hp=hp, type_="enemy", name=name)
